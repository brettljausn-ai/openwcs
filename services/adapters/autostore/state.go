...
// state.go holds the in-memory simulated device state and telemetry for the AutoStore adapter.
...
// deviceState is the simulated AutoStore grid's running tallies.
type deviceState struct {
	...
	binsRetrieved int64
	scanned       int64
	// ports is the number of carousel ports the simulated grid presents.
	ports int64
