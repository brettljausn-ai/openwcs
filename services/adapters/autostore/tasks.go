...
// tasks.go implements the uniform device contract POST /tasks for the AutoStore adapter.
...
// supportedCommands are the moves this AutoStore simulator accepts.
...
// adapter would call the grid controller and reconcile the outcome asynchronously.
