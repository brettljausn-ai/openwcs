 ...
 * {@code X-Auth-Warehouses}) onto outbound inter-service calls (counting to inventory / txlog /
 * master-data), so downstream RBAC and warehouse-scope checks see the original user. Background jobs
 * (no incoming request) forward nothing.
 */
@Configuration
