...
public class HttpTxLogClient implements TxLogClient {
    ...
    public HttpTxLogClient(RestClient.Builder builder,
                           @Value("${openwcs.counting.txlog-base-url:http://localhost:8086}") String baseUrl) {
    ...
    public UUID postStockAdjusted(StockAdjustment a) {
        ...
        body.put("actor", a.actor() == null ? "counting" : a.actor());
        body.put("correlationId", a.countTaskId());
