...
/**
 * Calls the canonical openWCS Host API. The SAP adapter is an anti-corruption layer: it
 * translates SAP-shaped messages into the vendor-neutral Host API rather than calling domain
 * services directly, so SAP-specifics stay isolated here.
 */
@Component
