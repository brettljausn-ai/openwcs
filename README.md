...
| `services/order-management` | Java | 8084 | Outbound orders + fulfilment lifecycle + release management (priority/dispatch-time); delegates allocation; order-flow report (expected/active/started + per-day and hour-of-day intake histograms per direction) |
