...
(function () {
  ...
  var I18N = {
    en: {
      ...
      a1t: 'Java 21 · Spring Boot', a1h: 'Domain services', a1p: 'master-data, inventory, orders, allocation, flow-orchestrator, txlog, IAM — each independently deployable.',
    ...
    de: {
      ...
      a1t: 'Java 21 · Spring Boot', a1h: 'Domänen-Services', a1p: 'master-data, inventory, orders, allocation, flow-orchestrator, txlog, IAM — jeder unabhängig deploybar.',
    ...
    fr: {
      ...
      a1t: 'Java 21 · Spring Boot', a1h: 'Services métier', a1p: 'master-data, inventory, orders, allocation, flow-orchestrator, txlog, IAM — chacun déployable indépendamment.',
    ...
    es: {
      ...
      a1t: 'Java 21 · Spring Boot', a1h: 'Servicios de dominio', a1p: 'master-data, inventory, orders, allocation, flow-orchestrator, txlog, IAM — cada uno desplegable de forma independiente.',
