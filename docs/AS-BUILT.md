...
_Last updated: 2026-06-08 (GTP console: persist mode per station, full-screen tote panel when idle, in-app counting delete dialog; WorkplaceView exposes acceptingWork for drain-state restore)_
